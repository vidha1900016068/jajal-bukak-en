...
footer.href = "https://www.instagram.com/vidhakhaa/";

document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Sayangku yang comel", "Aku ada pertanyaan nih buat kamu?", "question").then(function () {
    Swal.fire("Jawab yang jujur ya!").then(function () {
      Swal.fire("kalau boong bisulan!!", "", "error").then(function () {
